	...
	public void run() {
		...
		try {
			...
			while (!userInput.equals("2")) {
				...
				userInput = menu.getChoiceFromMainMenu(); // Calls the main menu, and saves input as "userInput". If we receive a 1. The loop will run again and we will display item
				// menu. If we receive a 2, the loop will end and code will continue. 
			}
			...
			// call purchaseMenu
			String purchaseInput= menu.getPurchaseMenu(); // call purchaseMenu, and save user input to "purchaseInput"
			while (!purchaseInput.equals("3")) { 
				if (purchaseInput.equals("1")) {
					...
					// end of feed money
							...
							/////////////////////////////////////////////// Purchase Menu Option 2) Select Product Menu //////////////////////////////////////////////////////
					...
					for (int i = 0; i < listOfItems.size(); i++) {   
						if(getProductCode.equals(listOfItems.get(i).getCode()))  {
							...
							////////////////////////////////////////////// Checking if there is enough money in the feed //////////////////////////////////////////////////////
							...
							if(itemPrice <= customerBalance) {
								...
								//////////////////////////////////////////// Updating the customer inventory /////////////////////////////////////////////////////////////////////
			...
			///////////////////////////////////////////////////////// 3) Purchase Menu Option 3) Finish Transaction ///////////////////////////////////////////////////////////
			
			// Creating our sales report based on the customers inventory
			...
			////////////////////////////////////////////////////// Converting remaining Balance to coins ////////////////////////////////////////////////////////////
